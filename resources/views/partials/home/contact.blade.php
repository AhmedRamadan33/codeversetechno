@php
    $addressData = array_filter([
        $company?->location ? ['title' => 'Address', 'description' => $company->location, 'icon' => 'location'] : null,
        $company?->email ? ['title' => 'Email Us', 'description' => $company->email, 'icon' => 'envelope'] : null,
        $company?->phone ? ['title' => 'Call Us', 'description' => $company->phone, 'icon' => 'phone'] : null,
    ]);
@endphp
        ...
        <div class="flex flex-col-reverse lg:gap-5 xl:gap-25.75 lg:flex-row justify-between">
            <div>
                <div>
                    ...
                    <p class="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                        We're available for new projects and partnerships. Drop us a line and tell us about your project.
                    </p>
                </div>
            ...
            <div class="w-full overflow-y-scroll py-6.5">
                ...
                <p class="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
                    We're always open to discussing new work or partnership opportunities.
                </p>
                <div class="mx-2">
