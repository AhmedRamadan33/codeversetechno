@php
    $services = [
        [
            ...
            'description' => 'Scalable RESTful APIs and backend systems built with Laravel and PHP, following MVC architecture and clean code principles.',
            'svgPath' => 'M4 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v2H4V6Zm0 5h16v7a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-7Zm3 3v2h2v-2H7Zm4 0v2h6v-2h-6Z',
        ],
        [
            'title' => 'Enterprise & ERP Solutions',
            'description' => 'End-to-end ERP and business management platforms covering finance, inventory, CRM, HR, and payroll.',
            'svgPath' => 'M4 21V8l8-5 8 5v13h-5v-7H9v7H4Zm7-9h2V8h-2v4Z',
        ],
        [
            'title' => 'Custom Web Platforms',
            'description' => 'Bespoke platforms for education, healthcare, and legal sectors — from LMS to clinic and case management systems.',
            'svgPath' => 'M3 4h18v13H3V4Zm2 2v9h14V6H5Zm2 12h10v2H7v-2Z',
        ],
        [
            'title' => 'Database Design',
            'description' => 'Efficient schemas and optimized MySQL queries for performance, with a focus on data integrity and scalability.',
            'svgPath' => 'M12 2c-4.42 0-8 1.34-8 3v14c0 1.66 3.58 3 8 3s8-1.34 8-3V5c0-1.66-3.58-3-8-3Zm0 2c3.87 0 6 1.07 6 1.5S15.87 7 12 7 6 5.93 6 5.5 8.13 4 12 4Zm-6 4.02c1.36.63 3.5 1 6 1s4.64-.37 6-1v3.48c0 .43-2.13 1.5-6 1.5s-6-1.07-6-1.5V8.02Zm0 5.52c1.36.63 3.5 1 6 1s4.64-.37 6-1v3.46c0 .43-2.13 1.5-6 1.5s-6-1.07-6-1.5v-3.46Z',
        ],
        [
            'title' => 'System Integration',
            'description' => 'Third-party integrations — payment gateways, notifications, video streaming, and real-time features.',
            'svgPath' => 'M8.5 7a4.5 4.5 0 1 0 0 9c1.06 0 2.03-.37 2.8-1L14 17.7A6.5 6.5 0 0 1 2 13.5 6.5 6.5 0 0 1 12.7 9.2L11 11.9a4.48 4.48 0 0 0-2.5-.9Zm10 3.2L21 12.7a6.5 6.5 0 0 1-10.7 4.3L12 15.3a4.5 4.5 0 0 0 6.5-4.1Z',
        ],
        [
            'title' => 'Security & Access Control',
            'description' => 'Secure authentication, authorization, and Role-Based Access Control (RBAC) built into every system we ship.',
            ...
            <div class="group p-6 xs:p-8 bg-white hover:shadow-xl shadow-gray-300 ease-out duration-500 rounded-lg relative overflow-hidden">
                ...
                <div class="w-12 h-12 bg-[#EDD8FF80] group-hover:bg-picto-primary center rounded-md transition-colors duration-500">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6">
                        <path d="{{ $service['svgPath'] }}" class="fill-picto-primary group-hover:fill-white transition-colors duration-500" />
                    </svg>
                </div>
