<div class="reveal content mt-10 md:mt-15 xl:mt-25 mb-10 md:mb-25 max-xxl:p-2" id="portfolio">
    <div class="xl:mb-17.5 mb-5">
        <div class="max-sm:px-2 text-center mx-auto max-w-144.25">
            ...
            <p class="font-normal text-[18px] max-sm:text-[14px] pt-6 text-gray-400">
                A selection of our recent projects, showcasing backend systems, APIs, and full-stack applications we've built for our clients.
            </p>
        </div>
    </div>
                    ...
                    <div class="max-w-106 rounded-lg outline-[#FFFFFF] hover:shadow-2xl duration-300 transition-all shadow-gray-300 border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-4 xs:p-8">
                            <div class="flex items-start justify-between gap-2">
                                <p class="text-picto-primary text-xs font-semibold uppercase tracking-wide">{{ $project->industry ?: 'Case Study' }}</p>
                                @if ($project->featured)
    ...
    @if ($company?->github_url)
        <div class="text-center">
            <a href="{{ $company->github_url }}" target="_blank" rel="noopener" class="btn btn-primary py-3 px-6 mt-12.5 text-center text-[16px] font-semibold">
                More on GitHub
            </a>
        </div>
    @endif
