<x-admin-layout title="Technologies">
    ...
    @if ($skills->isEmpty())
        <p class="text-sm text-zinc-500">No technologies yet.</p>
    @else
            ...
            @foreach ($skills as $skill)
                <div class="flex items-center justify-between gap-4 px-5 py-4">
                    ...
                    <div class="flex items-center gap-4 text-sm">
                        ...
                        <form method="POST" action="{{ route('admin.skills.destroy', $skill) }}" onsubmit="return confirm('Delete this technology?')">
                            @csrf
                            @method('DELETE')
